...
/* -------------- */
    ...
    #define hplhd                    32 /* Bijhouden hulpdienstingreep tbv (tijdelijk) lokaal VA regelen      */
    #define hplact                   33 /* Halfstar actief                                                    */
    #define hkpact                   34 /* Koppeling tbv halfstar actief                                      */
    #define hmlact                   35 /* Module regelen actief                                              */
    #define hpervar                  36 /* Periode VA regelen                                                 */
    #define hperarh                  37 /* Alternatieven voor hoofdrichtingen periode                         */
    #define homschtegenh             38 /* Bijhouden of omschakelen is toegestaan                             */
    #define hleven                   39 /* Bijhouden actief zijn levensignaal                                 */
    #define hxpl2232                 40 /* Tegenhouden richtingen tbv gelijkstart 22 32                       */
    #define hxpl243484               41 /* Tegenhouden richtingen tbv gelijkstart 24 34 84                    */
    #define hxpl2838                 42 /* Tegenhouden richtingen tbv gelijkstart 28 38                       */
    #define hxpl3384                 43 /* Tegenhouden richtingen tbv gelijkstart 33 84                       */
    #define hxpl2434                 44 /* Tegenhouden richtingen tbv gelijkstart 24 34                       */
    #define hxpl243384               45 /* Tegenhouden richtingen tbv gelijkstart 24 33 84                    */
    #define hnla02_1a                46 /* Onthouden detectiemelding detector 02_1a tbv naloop van 02 naar 62 */
    #define hnla02_1b                47 /* Onthouden detectiemelding detector 02_1b tbv naloop van 02 naar 62 */
    #define hnla08_1a                48 /* Onthouden detectiemelding detector 08_1a tbv naloop van 08 naar 68 */
    #define hnla08_1b                49 /* Onthouden detectiemelding detector 08_1b tbv naloop van 08 naar 68 */
    #define hnla11_1                 50 /* Onthouden detectiemelding detector 11_1 tbv naloop van 11 naar 68  */
    #define hnla22_1                 51 /* Onthouden detectiemelding detector 22_1 tbv naloop van 22 naar 21  */
    #define hnlak31a                 52 /* Onthouden detectiemelding detector k31a tbv naloop van 31 naar 32  */
    #define hnlak32a                 53 /* Onthouden detectiemelding detector k32a tbv naloop van 32 naar 31  */
    #define hnlak33a                 54 /* Onthouden detectiemelding detector k33a tbv naloop van 33 naar 34  */
    #define hnlak34a                 55 /* Onthouden detectiemelding detector k34a tbv naloop van 34 naar 33  */
    #define hnla82_1                 56 /* Onthouden detectiemelding detector 82_1 tbv naloop van 82 naar 81  */
    ...
    #define hprio02karbus            66 /* Bijhouden actief zijn prioriteit fase 02                           */
    #define hprioin02karbus          67 /* Prioriteit inmelding fase 02 Bus                                   */
    #define hpriouit02karbus         68 /* Prioriteit uitmelding 02 Bus                                       */
    #define hprioin02karbuskar       69 /* Prioriteit inmelding fase 02 Bus                                   */
    #define hpriouit02karbuskar      70 /* Prioriteit uitmelding 02 Bus                                       */
    ...
    #define hpelinKOP02             296 /* Bijhouden aanwezigheid peloton tbv peloton koppeling KOP02 fase 02 */
    #define hpeltegenhKOP02         297 /* Tegenhouden opzetten RW voor peloton koppeling KOP02 fase 02       */
    #define hpkud68_1aKOP68_uit     298 /* Bijhouden uitgaande status 68_1a voor koppeling KOP68_uit          */
    #define hpkud68_1bKOP68_uit     299 /* Bijhouden uitgaande status 68_1b voor koppeling KOP68_uit          */
    #define hperiodFietsprio1       300 /* Periode Fietsprio1 actief                                          */
    #define hperiodFietsprio2       301 /* Periode Fietsprio2 actief                                          */
    #define hptp123456iks01         302 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks02         303 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks03         304 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks04         305 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks05         306 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks06         307 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks07         308 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks08         309 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks09         310 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks10         311 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks11         312 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks12         313 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks13         314 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks14         315 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks15         316 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456iks16         317 /* Inkomende PTP signalen van kruising ptp123456                      */
    #define hptp123456uks01         318 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks02         319 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks03         320 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks04         321 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks05         322 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks06         323 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks07         324 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks08         325 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks09         326 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks10         327 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks11         328 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks12         329 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks13         330 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks14         331 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks15         332 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp123456uks16         333 /* Uitgaande PTP signalen naar ptp123456                              */
    #define hptp_ptp123456oke       334 /* Onthouden PTP oke ptp123456                                        */
    #define hptp_ptp123456err       335 /* Onthouden PTP error ptp123456                                      */
    #define hptp_ptp123456err0      336 /* Onthouden PTP error 0 ptp123456                                    */
    #define hptp_ptp123456err1      337 /* Onthouden PTP error 1 ptp123456                                    */
    #define hptp_ptp123456err2      338 /* Onthouden PTP error 2 ptp123456                                    */
    #define hrgvd24_3_d24_2         339 /* Onthouden detector melding 24 richtinggevoelig verlengen fase 24_3 */
    #define hrgvact                 340 /* Bijhouden actief zijn RoBuGrover                                   */
    #define hprreal02               341 /* Bijhouden primaire realisatie fase 02                              */
    #define hprreal03               342 /* Bijhouden primaire realisatie fase 03                              */
    #define hprreal05               343 /* Bijhouden primaire realisatie fase 05                              */
    #define hprreal08               344 /* Bijhouden primaire realisatie fase 08                              */
    #define hprreal11               345 /* Bijhouden primaire realisatie fase 11                              */
    #define hprreal22               346 /* Bijhouden primaire realisatie fase 22                              */
    #define hprreal28               347 /* Bijhouden primaire realisatie fase 28                              */
    #define hschoolingreepdk31a     348 /* Onthouden actief zijn schoolingreep voor fase 31 via detector k31a */
    #define hschoolingreepdk31b     349 /* Onthouden actief zijn schoolingreep voor fase 31 via detector k31b */
    #define hschoolingreepdk32a     350 /* Onthouden actief zijn schoolingreep voor fase 32 via detector k32a */
    #define hschoolingreepdk32b     351 /* Onthouden actief zijn schoolingreep voor fase 32 via detector k32b */
    #define hschoolingreepdk33a     352 /* Onthouden actief zijn schoolingreep voor fase 33 via detector k33a */
    #define hschoolingreepdk33b     353 /* Onthouden actief zijn schoolingreep voor fase 33 via detector k33b */
    #define hschoolingreepdk34a     354 /* Onthouden actief zijn schoolingreep voor fase 34 via detector k34a */
    #define hschoolingreepdk34b     355 /* Onthouden actief zijn schoolingreep voor fase 34 via detector k34b */
    #define hsiexgr31               356 /* Onthouden actief zijn senioreningreep bij fase 31                  */
    #define hsiexgr32               357 /* Onthouden actief zijn senioreningreep bij fase 32                  */
    #define hsiexgr33               358 /* Onthouden actief zijn senioreningreep bij fase 33                  */
    #define hsiexgr34               359 /* Onthouden actief zijn senioreningreep bij fase 34                  */
    #define hnleg0262               360
    #define hnleg0868               361
    #define hnleg1168               362
    #define hnleg2221               363
    #define hnlsg3132               364
    #define hnlsg3231               365
    #define hnlsg3334               366
    #define hnlsg3433               367
    #define hnleg8281               368
    #define hwtv24                  369 /* Onthouden aansturing wachttijdvoorspeller fase 24                  */
    ...
    #define hlos81                  376 /* Onthouden toestaan los realiseren fase 81                          */
    #define HEMAX1                  377
...
/* ----------- */
    ...
    #define schwg05                   312 /* Wachtstand groen fase 05                                                  */
    #define schwg08                   313 /* Wachtstand groen fase 08                                                  */
    #define schwg09                   314 /* Wachtstand groen fase 09                                                  */
    #define schwg11                   315 /* Wachtstand groen fase 11                                                  */
    #define schwg21                   316 /* Wachtstand groen fase 21                                                  */
    #define schwg22                   317 /* Wachtstand groen fase 22                                                  */
    #define schwg24                   318 /* Wachtstand groen fase 24                                                  */
    #define schwg26                   319 /* Wachtstand groen fase 26                                                  */
    #define schwg28                   320 /* Wachtstand groen fase 28                                                  */
    #define schwg31                   321 /* Wachtstand groen fase 31                                                  */
    #define schwg32                   322 /* Wachtstand groen fase 32                                                  */
    #define schwg33                   323 /* Wachtstand groen fase 33                                                  */
    #define schwg34                   324 /* Wachtstand groen fase 34                                                  */
    #define schwg38                   325 /* Wachtstand groen fase 38                                                  */
    #define schwg61                   326 /* Wachtstand groen fase 61                                                  */
    #define schwg62                   327 /* Wachtstand groen fase 62                                                  */
    #define schwg67                   328 /* Wachtstand groen fase 67                                                  */
    #define schwg68                   329 /* Wachtstand groen fase 68                                                  */
    #define schwg81                   330 /* Wachtstand groen fase 81                                                  */
    #define schwg82                   331 /* Wachtstand groen fase 82                                                  */
    #define schwg84                   332 /* Wachtstand groen fase 84                                                  */
    #define schwtv24                  333 /* Aansturing wachttijdvoorspeller fase 24 aan of uit                        */
    #define schwtvbusbijhd            334 /* Aansturing wachttijdvoorspeller BUS licht bij HD ingreep                  */
    #define schstar                   335 /* Inschakelen star programma                                                */
    #define schgs2232                 336 /* Schakelbare gelijkstart tussen fase 32 en 22                              */
    #define schgs2434                 337 /* Schakelbare gelijkstart tussen fase 34 en 24                              */
    #define schgs2484                 338 /* Schakelbare gelijkstart tussen fase 84 en 24                              */
    #define schgs3384                 339 /* Schakelbare gelijkstart tussen fase 84 en 33                              */
