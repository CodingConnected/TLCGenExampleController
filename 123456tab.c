...
/* ----------- */
    ...
    SCH_code[schgeennla0262]           = "geennla0262";           SCH[schgeennla0262]           = 0;                                        /* Wel/niet toestaan losse realisatie 02                                */
    SCH_code[schlos0868]               = "los0868";               SCH[schlos0868]               = 0;                                        /* Wel/niet toestaan losse realisatie 08                                */
    SCH_code[schgeennla0868]           = "geennla0868";           SCH[schgeennla0868]           = 0;                                        /* Wel/niet toestaan losse realisatie 08                                */
    SCH_code[schlos1168]               = "los1168";               SCH[schlos1168]               = 0;                                        /* Wel/niet toestaan losse realisatie 11                                */
    SCH_code[schgeennla1168]           = "geennla1168";           SCH[schgeennla1168]           = 0;                                        /* Wel/niet toestaan losse realisatie 11                                */
    SCH_code[schlos2221]               = "los2221";               SCH[schlos2221]               = 0;                                        /* Wel/niet toestaan losse realisatie 22                                */
    SCH_code[schgeennla2221]           = "geennla2221";           SCH[schgeennla2221]           = 0;                                        /* Wel/niet toestaan losse realisatie 22                                */
    SCH_code[schlos3132]               = "los3132";               SCH[schlos3132]               = 0;                                        /* Wel/niet toestaan losse realisatie 31                                */
    SCH_code[schgeennla3132]           = "geennla3132";           SCH[schgeennla3132]           = 0;                                        /* Wel/niet toestaan losse realisatie 31                                */
    SCH_code[schlos3231]               = "los3231";               SCH[schlos3231]               = 0;                                        /* Wel/niet toestaan losse realisatie 32                                */
    SCH_code[schgeennla3231]           = "geennla3231";           SCH[schgeennla3231]           = 0;                                        /* Wel/niet toestaan losse realisatie 32                                */
    SCH_code[schlos3334]               = "los3334";               SCH[schlos3334]               = 0;                                        /* Wel/niet toestaan losse realisatie 33                                */
    SCH_code[schgeennla3334]           = "geennla3334";           SCH[schgeennla3334]           = 0;                                        /* Wel/niet toestaan losse realisatie 33                                */
    SCH_code[schlos3433]               = "los3433";               SCH[schlos3433]               = 0;                                        /* Wel/niet toestaan losse realisatie 34                                */
    SCH_code[schgeennla3433]           = "geennla3433";           SCH[schgeennla3433]           = 0;                                        /* Wel/niet toestaan losse realisatie 34                                */
    SCH_code[schlos8281]               = "los8281";               SCH[schlos8281]               = 0;                                        /* Wel/niet toestaan losse realisatie 82                                */
    SCH_code[schgeennla8281]           = "geennla8281";           SCH[schgeennla8281]           = 0;                                        /* Wel/niet toestaan losse realisatie 82                                */
