...
/* ----------------- */
    ...
    US_code[uswtv21]             = "wtv21";                                           /* Multivalente aansturing wachttijdvoorspeller fase 21                        */
    US_code[uswtv22]             = "wtv22";                                           /* Multivalente aansturing wachttijdvoorspeller fase 22                        */
    US_code[uswtv24]             = "wtv24";                                           /* Multivalente aansturing wachttijdvoorspeller fase 24                        */
    US_code[uswtv26]             = "wtv26";                                           /* Multivalente aansturing wachttijdvoorspeller fase 26                        */
    US_code[uswtv28]             = "wtv28";                                           /* Multivalente aansturing wachttijdvoorspeller fase 28                        */
    US_code[uswtv81]             = "wtv81";                                           /* Multivalente aansturing wachttijdvoorspeller fase 81                        */
    US_code[uswtv82]             = "wtv82";                                           /* Multivalente aansturing wachttijdvoorspeller fase 82                        */
    US_code[uswtv84]             = "wtv84";                                           /* Multivalente aansturing wachttijdvoorspeller fase 84                        */
...
/* -------------- */
    ...
    T_code[thdin02opt]                 = "hdin02opt";                 T_max[thdin02opt]                 = 10;   T_type[thdin02opt]                 = TE_type; /* Anti jutter tijd inmelden HD 02 Opticom                                                  */
    ...
    T_code[thdin05opt]                 = "hdin05opt";                 T_max[thdin05opt]                 = 10;   T_type[thdin05opt]                 = TE_type; /* Anti jutter tijd inmelden HD 05 Opticom                                                  */
    ...
    T_code[thdin08opt]                 = "hdin08opt";                 T_max[thdin08opt]                 = 10;   T_type[thdin08opt]                 = TE_type; /* Anti jutter tijd inmelden HD 08 Opticom                                                  */
    ...
    T_code[thdin11opt]                 = "hdin11opt";                 T_max[thdin11opt]                 = 10;   T_type[thdin11opt]                 = TE_type; /* Anti jutter tijd inmelden HD 11 Opticom                                                  */
...
/* ----------- */
    ...
    SCH_code[schgeenlokgroen0262]      = "geenlokgroen0262";      SCH[schgeenlokgroen0262]      = 0;                                        /* Tegenhouden lokgroen (tegenhouden naloop bij aanvraag voedende richting) */
    ...
    SCH_code[schgeenlokgroen0868]      = "geenlokgroen0868";      SCH[schgeenlokgroen0868]      = 0;                                        /* Tegenhouden lokgroen (tegenhouden naloop bij aanvraag voedende richting) */
    ...
    SCH_code[schgeenlokgroen1168]      = "geenlokgroen1168";      SCH[schgeenlokgroen1168]      = 0;                                        /* Tegenhouden lokgroen (tegenhouden naloop bij aanvraag voedende richting) */
    ...
    SCH_code[schgeenlokgroen2221]      = "geenlokgroen2221";      SCH[schgeenlokgroen2221]      = 0;                                        /* Tegenhouden lokgroen (tegenhouden naloop bij aanvraag voedende richting) */
    ...
    SCH_code[schgeenlokgroen3132]      = "geenlokgroen3132";      SCH[schgeenlokgroen3132]      = 0;                                        /* Tegenhouden lokgroen (tegenhouden naloop bij aanvraag voedende richting) */
...
/* ---------- */
    ...
    PRM_code[prmzz]                       = "zz";                       PRM[prmzz]                       = 20;                                                    /* Versiebeheer zz                                                                                                                */
    ...
    PRM_code[prmetkpoFietsprio1]          = "etkpoFietsprio1";          PRM[prmetkpoFietsprio1]          = 0;    PRM_type[prmetkpoFietsprio1]          = TI_type; /* Einde klokperiode Fietsprio1                                                                                                   */
...
/* ------------------------ */
    ...
    SCH_cat[schgeenlokgroen0262]   = CAT_Basisfuncties;    SCH_subcat[schgeenlokgroen0262]      = SUBCAT_Deelconflicten;
    SCH_cat[schgeennla0262]        = CAT_Basisfuncties;    SCH_subcat[schgeennla0262]           = SUBCAT_Deelconflicten;
    SCH_cat[schgeenlokgroen0868]   = CAT_Basisfuncties;    SCH_subcat[schgeenlokgroen0868]      = SUBCAT_Deelconflicten;
    SCH_cat[schgeennla0868]        = CAT_Basisfuncties;    SCH_subcat[schgeennla0868]           = SUBCAT_Deelconflicten;
    SCH_cat[schgeenlokgroen1168]   = CAT_Basisfuncties;    SCH_subcat[schgeenlokgroen1168]      = SUBCAT_Deelconflicten;
    SCH_cat[schgeennla1168]        = CAT_Basisfuncties;    SCH_subcat[schgeennla1168]           = SUBCAT_Deelconflicten;
    SCH_cat[schgeenlokgroen2221]   = CAT_Basisfuncties;    SCH_subcat[schgeenlokgroen2221]      = SUBCAT_Deelconflicten;
    ...
    SCH_cat[schgeenlokgroen8281]   = CAT_Basisfuncties;    SCH_subcat[schgeenlokgroen8281]      = SUBCAT_Deelconflicten;
    ...
    T_cat[thdin02opt]              = CAT_Prioriteren;      T_subcat[thdin02opt]                 = SUBCAT_OpenbaarVervoer;
    ...
    T_cat[thdin05opt]              = CAT_Prioriteren;      T_subcat[thdin05opt]                 = SUBCAT_OpenbaarVervoer;
    ...
    T_cat[thdin08opt]              = CAT_Prioriteren;      T_subcat[thdin08opt]                 = SUBCAT_OpenbaarVervoer;
    ...
    T_cat[thdin11opt]              = CAT_Prioriteren;      T_subcat[thdin11opt]                 = SUBCAT_OpenbaarVervoer;
