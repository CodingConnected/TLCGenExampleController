...
boolv Correctie_REALTIJD_Voorstart(count fcvs, count fcns, count tvs);
boolv Correctie_REALTIJD_Gelijkstart(count fc1, count fc2);
boolv Correctie_REALTIJD_LateRelease(count fclr, count fcvs, count tlr);
...
boolv ym_max_tig_realtijd(count i, count prmomx);
...
void Realisatietijd_NLEG(count i, count j, count tnlfg, count tnlfgd, count tnleg, count tnlegd, count tvgnaloop)
{
    ...
    for (n = 0; n < KFC_MAX[j]; n++)
    {
        ...
        if (!AR[i])
        {
            if (VS[i])
            {
                if ((REALTIJD[i][k] < (TFG_max[i] + T_max[tnlfg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlfg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + T_max[tnlfg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] + T_max[tnlfgd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlfgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + T_max[tnlfgd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_max[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnleg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_max[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_max[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_max[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            else if (FG[i])
            {
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + T_max[tnlfg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlfg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + T_max[tnlfg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + T_max[tnlfgd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlfgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + T_max[tnlfgd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_max[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnleg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_max[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_max[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_max[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            else if (WG[i])
            {
                if ((REALTIJD[i][k] < (T_max[tnlfg] - T_timer[tnlfg] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k])) && !(tnlfg == NG))
                {
                    REALTIJD[i][k] = (T_max[tnlfg] - T_timer[tnlfg] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (T_max[tnlfgd] - T_timer[tnlfgd] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k])) && !(tnlfgd == NG))
                {
                    REALTIJD[i][k] = (T_max[tnlfgd] - T_timer[tnlfgd] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TVG_max[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnleg == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TVG_max[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            else if (VG[i] && (TVG_max[i] > TVG_timer[i]))
            {
                ...
                if ((REALTIJD[i][k] < (TVG_max[i] - TVG_timer[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnleg == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] - TVG_timer[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TVG_max[i] - TVG_timer[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] - TVG_timer[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            else if (MG[i] || VG[i] && (TVG_max[i] <= TVG_timer[i]))
            {
                ...
                if ((REALTIJD[i][k] < (T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnleg == NG))
                {
                    REALTIJD[i][k] = (T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            else if (GL[i])
            {
                if ((REALTIJD[i][k] < (T_max[tnlfg] - T_timer[tnlfg] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j])) && !(tnlfg == NG))
                {
                    REALTIJD[i][k] = (T_max[tnlfg] - T_timer[tnlfg] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j]);
                }
                if ((REALTIJD[i][k] < (T_max[tnlfgd] - T_timer[tnlfgd] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j])) && !(tnlfgd == NG))
                {
                    REALTIJD[i][k] = (T_max[tnlfgd] - T_timer[tnlfgd] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j]);
                }
                if ((REALTIJD[i][k] < (T_max[tnleg] - T_timer[tnleg] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j])) && !(tnleg == NG))
                {
                    REALTIJD[i][k] = (T_max[tnleg] - T_timer[tnleg] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j]);
                }
                if ((REALTIJD[i][k] < (TGL_max[i] - TGL_timer[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TGL_max[i] - TGL_timer[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            else if (TIG[j][k])
            {
                ...
                if ((REALTIJD[i][k] < (T_max[tnlegd] - T_timer[tnlegd] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (T_max[tnlegd] - T_timer[tnlegd] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j]);
                }
            }
        }
        if (AR[i])
        {
            if (VS[i])
            {
                ...
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_AR[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnleg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_AR[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_AR[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_AR[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            else if (FG[i])
            {
                ...
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnleg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            else if (WG[i])
            {
                ...
                if ((REALTIJD[i][k] < (TVG_AR[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnleg == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TVG_AR[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            else if (VG[i] && (TVG_AR[i] > TVG_timer[i]))
            {
                ...
                if ((REALTIJD[i][k] < (TVG_AR[i] - TVG_timer[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnleg == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] - TVG_timer[i] + T_max[tnleg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TVG_AR[i] - TVG_timer[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] - TVG_timer[i] + TGL_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
    ...
    for (n = KFC_MAX[j]; n < GKFC_MAX[j]; n++)
    {
        ...
        if (!AR[i])
        {
            if (VS[i])
            {
                ...
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_max[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            else if (FG[i])
            {
        ...
        if (AR[i])
        {
            if (VS[i])
            {
                ...
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_AR[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlegd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_AR[i] + T_max[tnlegd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            else if (FG[i])
            {
...
void Realisatietijd_NLEVG(count i, count j, count tnlfg, count tnlfgd, count tnlevg, count tnlevgd, count tvgnaloop)
{
    ...
    for (n = 0; n < KFC_MAX[j]; n++)
    {
        ...
        if (!AR[i])
        {
            if (VS[i])
            {
                ...
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            if (FG[i])
            {
                ...
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            if (WG[i])
            {
                ...
                if ((REALTIJD[i][k] < (TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            if (VG[i] && (TVG_max[i] > TVG_timer[i]))
            {
                ...
                if ((REALTIJD[i][k] < (TVG_max[i] - TVG_timer[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] - TVG_timer[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TVG_max[i] - TVG_timer[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] - TVG_timer[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            if ((VG[i] && (TVG_max[i] >= TVG_timer[i]) || MG[i] || !G[i]) && TIG[j][k])
            {
                ...
                if ((REALTIJD[i][k] < (T_max[tnlevg] - T_timer[tnlevg] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (T_max[tnlevg] - T_timer[tnlevg] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j]);
                }
                if ((REALTIJD[i][k] < (T_max[tnlevgd] - T_timer[tnlevgd] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (T_max[tnlevgd] - T_timer[tnlevgd] + T_max[tvgnaloop] - T_timer[tvgnaloop] + TIG_max[j][k] - TIG_timer[j]);
                }
            }
        ...
        if (AR[i])
        {
            if (VS[i])
            {
                ...
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            if (FG[i])
            {
                ...
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            if (WG[i])
            {
                ...
                if ((REALTIJD[i][k] < (TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
            if (VG[i] && (TVG_AR[i] > TVG_timer[i]))
            {
                ...
                if ((REALTIJD[i][k] < (TVG_AR[i] - TVG_timer[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] - TVG_timer[i] + T_max[tnlevg] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
                if ((REALTIJD[i][k] < (TVG_AR[i] - TVG_timer[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] - TVG_timer[i] + T_max[tnlevgd] + T_max[tvgnaloop] + TIG_max[j][k]);
                }
            }
    ...
    for (n = KFC_MAX[j]; n < GKFC_MAX[j]; n++)
    {
        ...
        if (!AR[i])
        {
            if (VS[i])
            {
                if ((REALTIJD[i][k] < (TFG_max[i] + T_max[tnlfg] + T_max[tvgnaloop])) && !(tnlfg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + T_max[tnlfg] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] + T_max[tnlfgd] + T_max[tvgnaloop])) && !(tnlfgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + T_max[tnlfgd] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop]);
                }
            }
            if (FG[i])
            {
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + T_max[tnlfg] + T_max[tvgnaloop])) && !(tnlfg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + T_max[tnlfg] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + T_max[tnlfgd] + T_max[tvgnaloop])) && !(tnlfgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + T_max[tnlfgd] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop]);
                }
            }
            if (WG[i])
            {
                if ((REALTIJD[i][k] < (T_max[tnlfg] - T_timer[tnlfg] + T_max[tvgnaloop] - T_timer[tvgnaloop])) && !(tnlfg == NG))
                {
                    REALTIJD[i][k] = (T_max[tnlfg] - T_timer[tnlfg] + T_max[tvgnaloop] - T_timer[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (T_max[tnlfgd] - T_timer[tnlfgd] + T_max[tvgnaloop] - T_timer[tvgnaloop])) && !(tnlfgd == NG))
                {
                    REALTIJD[i][k] = (T_max[tnlfgd] - T_timer[tnlfgd] + T_max[tvgnaloop] - T_timer[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] + T_max[tnlevg] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] + T_max[tnlevgd] + T_max[tvgnaloop]);
                }
            }
            if (VG[i] && (TVG_max[i] > TVG_timer[i]))
            {
                ...
                if ((REALTIJD[i][k] < (TVG_max[i] - TVG_timer[i] + T_max[tnlevg] + T_max[tvgnaloop])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] - TVG_timer[i] + T_max[tnlevg] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TVG_max[i] - TVG_timer[i] + T_max[tnlevgd] + T_max[tvgnaloop])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TVG_max[i] - TVG_timer[i] + T_max[tnlevgd] + T_max[tvgnaloop]);
                }
        ...
        if (AR[i])
        {
            if (VS[i])
            {
                ...
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] + TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] + TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop]);
                }
            }
            if (FG[i])
            {
                ...
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TFG_max[i] - TFG_timer[i] + TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop]);
                }
            }
            if (WG[i])
            {
                ...
                if ((REALTIJD[i][k] < (TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] + T_max[tnlevg] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] + T_max[tnlevgd] + T_max[tvgnaloop]);
                }
            }
            if (VG[i] && (TVG_max[i] > TVG_timer[i]))
            {
                ...
                if ((REALTIJD[i][k] < (TVG_AR[i] - TVG_timer[i] + T_max[tnlevg] + T_max[tvgnaloop])) && !(tnlevg == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] - TVG_timer[i] + T_max[tnlevg] + T_max[tvgnaloop]);
                }
                if ((REALTIJD[i][k] < (TVG_AR[i] - TVG_timer[i] + T_max[tnlevgd] + T_max[tvgnaloop])) && !(tnlevgd == NG))
                {
                    REALTIJD[i][k] = (TVG_AR[i] - TVG_timer[i] + T_max[tnlevgd] + T_max[tvgnaloop]);
                }
...
void Realisatietijd_NLSG(count i, count j, count tnlsg, count tnlsgd)
{
    ...
    for (n = 0; n < KFC_MAX[j]; n++)
    {
        ...
        {
            if ((REALTIJD[i][k] < (T_max[tnlsg] + TIG_max[j][k])) && !(tnlsg == NG))
            {
                REALTIJD[i][k] = T_max[tnlsg] + TIG_max[j][k];
            }
            if ((REALTIJD[i][k] < (T_max[tnlsgd] + TIG_max[j][k])) && !(tnlsgd == NG))
            {
                REALTIJD[i][k] = T_max[tnlsgd] + TIG_max[j][k];
            }
        }
        else if (T[tnlsg] || T[tnlsgd])
        {
            if ((REALTIJD[i][k] < (T_max[tnlsg] - T_timer[tnlsg] + TIG_max[j][k])) && !(tnlsg == NG))
            {
                REALTIJD[i][k] = T_max[tnlsg] - T_timer[tnlsg] + TIG_max[j][k];
            }
            if ((REALTIJD[i][k] < (T_max[tnlsgd] - T_timer[tnlsgd] + TIG_max[j][k])) && !(tnlsgd == NG))
            {
                REALTIJD[i][k] = T_max[tnlsgd] - T_timer[tnlsgd] + TIG_max[j][k];
            }
        }
    }
}
...
boolv Correctie_REALTIJD_Voorstart(count fcvs, count fcns, count tvs)
{
    ...
    if ((A[fcvs] || !(PG[fcvs] & PRIMAIR_OVERSLAG) || TRUE) && !G[fcvs])
    {
        for (n = 0; n < FCMAX; ++n)
        {
            if ((REALTIJD[n][fcns] < REALTIJD[n][fcvs] + T_max[tvs]) && REALTIJD[n][fcvs] > 0)
            {
                REALTIJD[n][fcns] = REALTIJD[n][fcvs] + T_max[tvs];
                result = TRUE;
            }
        }
    }
    if (G[fcvs] || RA[fcvs] && (REALTIJD_max[fcvs] <= 1))
    {
        if (TG[fcvs])
        {
            if (REALTIJD[fcvs][fcns] < (T_max[tvs] - TG_timer[fcvs]))
            {
                REALTIJD[fcvs][fcns] = T_max[tvs] - TG_timer[fcvs];
                result = TRUE;
            }
        }
        else
        {
            if (REALTIJD[fcvs][fcns] < T_max[tvs])
            {
                REALTIJD[fcvs][fcns] = T_max[tvs];
                result = TRUE;
            }
        }
    }
...
boolv Correctie_REALTIJD_Gelijkstart(count fc1, count fc2)
{
    ...
    for (n = 0; n < FCMAX; ++n)
    {
        ...
        {
            {
                if (REALTIJD[n][fc1] < REALTIJD[n][fc2])
                {
                    REALTIJD[n][fc1] = REALTIJD[n][fc2];
                    result = TRUE;
                }
                else
                {
...
boolv Correctie_REALTIJD_LateRelease(count fclr, count fcvs, count tlr)
{
    ...
    for (n = 0; n < FCMAX; ++n)
    {
        if (A[fclr] || !PG[fclr] || TRUE)
        {
            if (!G[fcvs])
            {
                if (REALTIJD[n][fcvs] < REALTIJD[n][fclr] - T_max[tlr])
                {
                    REALTIJD[n][fcvs] = REALTIJD[n][fclr] - T_max[tlr];
                    if (REALTIJD[n][fcvs] < 0) REALTIJD[n][fcvs] = 0;
                    result = TRUE;
                }
            }
        }
...
void Ontruiming_Deelconflict_Voorstart(count fcns, count fcvs, count tfo)
{
    ...
    if ((RT[tfo] || T[tfo]) && !G[fcvs])
    {
        if (VS[fcns])
        {
            REALTIJD[fcns][fcvs] = TFG_max[fcns] + TVG_max[fcns] + T_max[tfo];
        }
        if (FG[fcns])
        {
            REALTIJD[fcns][fcvs] = TFG_max[fcns] - TFG_timer[fcns] + TVG_max[fcns] + T_max[tfo];
        }
        if (WG[fcns])
        {
            REALTIJD[fcns][fcvs] = TVG_max[fcns] + T_max[tfo];
        }
        if (VG[fcns] && (TVG_max[fcns] > TVG_timer[fcns]))
        {
            REALTIJD[fcns][fcvs] = TVG_max[fcns] - TVG_timer[fcns] + T_max[tfo];
        }
        if (MG[fcns] || VG[fcns] && (TVG_max[fcns] <= TVG_timer[fcns]))
        {
            REALTIJD[fcns][fcvs] = T_max[tfo];
        }
        if (T[tfo] && !G[fcns])
        {
            REALTIJD[fcns][fcvs] = T_max[tfo] - T_timer[tfo];
        }
    }
}
void Ontruiming_Deelconflict_Gelijkstart(count fc1, count fc2, count tfo12, count tfo21)
{
    ...
    if ((RT[tfo12] || T[tfo12]) && !G[fc2])
    {
        if (VS[fc1])
        {
            REALTIJD[fc1][fc2] = TFG_max[fc1] + TVG_max[fc1] + T_max[tfo12];
        }
        if (FG[fc1])
        {
            REALTIJD[fc1][fc2] = TFG_max[fc1] - TFG_timer[fc1] + TVG_max[fc1] + T_max[tfo12];
        }
        if (WG[fc1])
        {
            REALTIJD[fc1][fc2] = TVG_max[fc1] + T_max[tfo12];
        }
        if (VG[fc1])
        {
            REALTIJD[fc1][fc2] = TVG_max[fc1] - TVG_timer[fc1] + T_max[tfo12];

        }
        if (MG[fc1])
        {
            REALTIJD[fc1][fc2] = T_max[tfo12];
        }
        if (T[tfo12] && !G[fc1])
        {
            REALTIJD[fc1][fc2] = T_max[tfo12] - T_timer[tfo12];
        }
    }
    RT[tfo21] = G[fc2];
    {
        if (VS[fc2])
        {
            REALTIJD[fc2][fc1] = TFG_max[fc2] + TVG_max[fc2] + T_max[tfo21];
        }
        if (FG[fc2])
        {
            REALTIJD[fc2][fc1] = TFG_max[fc2] - TFG_timer[fc2] + TVG_max[fc2] + T_max[tfo21];
        }
        if (WG[fc2])
        {
            REALTIJD[fc2][fc1] = TVG_max[fc2] + T_max[tfo21];
        }
        if (VG[fc2])
        {
            REALTIJD[fc2][fc1] = TVG_max[fc2] - TVG_timer[fc2] + T_max[tfo21];

        }
        if (MG[fc2])
        {
            REALTIJD[fc2][fc1] = T_max[tfo21];
        }
        if (T[tfo21] && !G[fc2])
        {
            REALTIJD[fc2][fc1] = T_max[tfo21] - T_timer[tfo21];
        }
    }
}
void Ontruiming_Deelconflict_LateRelease(count fcvs, count fclr, count tlr, count tfo)
{
    ...
    if ((RT[tfo] || T[tfo]) && !G[fclr])
    {
        if (VS[fcvs])
        {
            REALTIJD[fcvs][fclr] = TFG_max[fcvs] + TVG_max[fcvs] + T_max[tfo];
        }
        if (FG[fcvs])
        {
            REALTIJD[fcvs][fclr] = TFG_max[fcvs] - TFG_timer[fcvs] + TVG_max[fcvs] + T_max[tfo];
        }
        if (WG[fcvs])
        {
            REALTIJD[fcvs][fclr] = TVG_max[fcvs] + T_max[tfo];
        }
        if (VG[fcvs])
        {
            REALTIJD[fcvs][fclr] = TVG_max[fcvs] - TVG_timer[fcvs] + T_max[tfo];
        }
        if (MG[fcvs])
        {
            REALTIJD[fcvs][fclr] = T_max[tfo];
        }
        if (T[tfo] && !G[fcvs])
        {
            REALTIJD[fcvs][fclr] = T_max[tfo] - T_timer[tfo];
        }
...
boolv ym_max_tig_realtijd(count i,count prmomx) /* todo fc22 moet met 5 meeverlengen als 11 groen is. */
{
    ...
    {     /* let op! i.v.m. snelheid alleen in MG[] behandeld	*/
        ...
        {
            k = KF_pointer[i][n];
            if ((RA[k] || AAPR[k]) && !(FK_type[i][k] == FK_SG) && !(FK_type[i][k] == FK_EVG) && (REALTIJD_max[k] > 0))
            {
                ym = FALSE;
                for (j = 0; j < FKFC_MAX[k]; j++)
                {
                    m = KF_pointer[k][j];
                    if ((REALTIJD[m][k] > REALTIJD[i][k] + PRM[prmomx]) && !(TNL_type[m][i] == TNL_EG))
                    {
                        ym = TRUE;
                        break;
                    }
...
boolv max_par(count fc)
{
    ...
    {
        k = KF_pointer[fc][n];
        if (AAPR[k] && ((REALTIJD_max[k] - REALTIJD_max[fc] + offsetAR) < TISG_AR[fc][k]) || CV[k] ||
            (A[k]||PRIOFC[k]) && ((twacht[k] - REALTIJD_max[fc] + offsetAR) < TISG_AR[fc][k]))
        {
            return FALSE;
        }
...
boolv max_par_los(fc)
{
    ...
    {
        k = KF_pointer[fc][n];
        if (AAPR[k] && !((TIG_max[fc][k] == FK) && (FK_type[fc][k] == FK_SG)) && ((REALTIJD_max[k] - REALTIJD_max[fc] + offsetAR) < TISG_AR[fc][k])) return FALSE;
    }
    return TRUE;
}
void max_wachttijd_modulen_primair_ISG(boolv* prml[], count ml, count ml_max, mulv twacht[])
...
void Bepaal_Realisatietijd_per_richting(void)
{
    ...
    for (i = 0; i < FCMAX; ++i)
    {
        ...
        for (j = 0; j < FCMAX; ++j)
        {
            if (REALTIJD_max[i] < REALTIJD[j][i]) REALTIJD_max[i] = REALTIJD[j][i];
        }
    }
}
    ...
    for (fc = 0; fc < FCMAX; fc++)
    {
        if (TIGR[fc2][fc] >= 0)
        {
            if (!AR[fc1])
            {
                if (VS[fc1])
                {
                    if (REALTIJD[fc1][fc] < TFG_max[fc1] + TVG_max[fc1] + TIGR[fc2][fc])
                        REALTIJD[fc1][fc] = TFG_max[fc1] + TVG_max[fc1] + TIGR[fc2][fc];
                }
                if (FG[fc1])
                {
                    if (REALTIJD[fc1][fc] < TFG_max[fc1] - TFG_timer[fc1] + TVG_max[fc1] + TIGR[fc2][fc])
                        REALTIJD[fc1][fc] = TFG_max[fc1] - TFG_timer[fc1] + TVG_max[fc1] + TIGR[fc2][fc];
                }
                if (WG[fc1])
                {
                    if (REALTIJD[fc1][fc] < TVG_max[fc1] + TIGR[fc2][fc])
                        REALTIJD[fc1][fc] = TVG_max[fc1] + TIGR[fc2][fc];
                }
                if (VG[fc1] && (TVG_timer[fc1] <= TVG_max[fc1]))
                {
                    if (REALTIJD[fc1][fc] < TVG_max[fc1] - TVG_timer[fc1] + TIGR[fc2][fc])
                        REALTIJD[fc1][fc] = TVG_max[fc1] - TVG_timer[fc1] + TIGR[fc2][fc];
                }
                if (MG[fc1] || VG[fc1] && (TVG_timer[fc1] > TVG_max[fc1]))
                {
                    if (REALTIJD[fc1][fc] < TIGR[fc2][fc])
                        REALTIJD[fc1][fc] = TIGR[fc2][fc];
                }
            }
            else
            {
                if (VS[fc1])
                {
                    if (REALTIJD[fc1][fc] < TFG_max[fc1] + TVG_AR[fc1] + TIGR[fc2][fc])
                        REALTIJD[fc1][fc] = TFG_max[fc1] + TVG_AR[fc1] + TIGR[fc2][fc];
                }
                if (FG[fc1])
                {
                    if (REALTIJD[fc1][fc] < TFG_max[fc1] - TFG_timer[fc1] + TVG_AR[fc1] + TIGR[fc2][fc])
                        REALTIJD[fc1][fc] = TFG_max[fc1] - TFG_timer[fc1] + TVG_AR[fc1] + TIGR[fc2][fc];
                }
                if (WG[fc1])
                {
                    if (REALTIJD[fc1][fc] < TVG_AR[fc1] + TIGR[fc2][fc])
                        REALTIJD[fc1][fc] = TVG_AR[fc1] + TIGR[fc2][fc];
                }
                if (VG[fc1] && (TVG_timer[fc1] <= TVG_AR[fc1]))
                {
                    if (REALTIJD[fc1][fc] < TVG_AR[fc1] - TVG_timer[fc1] + TIGR[fc2][fc])
                        REALTIJD[fc1][fc] = TVG_AR[fc1] - TVG_timer[fc1] + TIGR[fc2][fc];
                }
                if (MG[fc1] || VG[fc1] && (TVG_timer[fc1] > TVG_AR[fc1]))
                {
                    if (REALTIJD[fc1][fc] < TIGR[fc2][fc])
...
void MeeverlengenUitDoorVoetgangerLos(count fcvtg, count hmadk)
{
    ...
    for (n = 0; n < FKFC_MAX[fcvtg]; ++n)
    {
        ...
        if ((REALTIJD[fc][fcvtg] > 0) && MG[fc]) YM[fc] = FALSE;
    }
}
