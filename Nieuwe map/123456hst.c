...
void Synchronisaties_halfstar(void)
{
    ...
    naloopEG_CV_halfstar(TRUE, fc02, fc62, PRM[prmxnl0262], tnlegd0262, tnleg0262);
    naloopEG_CV_halfstar(TRUE, fc08, fc68, PRM[prmxnl0868], tnlegd0868, tnleg0868);
    naloopEG_CV_halfstar(TRUE, fc11, fc68, PRM[prmxnl1168], tnlegd1168, tnleg1168);
    naloopEG_CV_halfstar(TRUE, fc22, fc21, PRM[prmxnl2221], tnlegd2221, tnleg2221);
    ...
    naloopEG_CV_halfstar(TRUE, fc82, fc81, PRM[prmxnl8281], tnlegd8281, tnleg8281);
    inloopSG_halfstar(fc31, fc32, tlr3231);
    inloopSG_halfstar(fc32, fc31, tlr3132);
    inloopSG_halfstar(fc33, fc34, tlr3433);
    inloopSG_halfstar(fc34, fc33, tlr3334);
