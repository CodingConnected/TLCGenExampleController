...
extern mulv REALISATIETIJD_max_wtv[FCMAX];
...
boolv Realisatietijd_LateRelease_Correctie(mulv realisatietijd[FCMAX][FCMAX], count fclr, count fcvs, count tlr);
...
void InterStartGroenTijden_VulConflictenIn();
