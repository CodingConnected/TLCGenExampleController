...
/* ---------- */
    ...
    #define prmrisastart38vtg1         604 /* Afstand van stopstreep tot start aanvraag gebied RIS CAM fase 38                                  */
    #define prmrisastartsrm038vtg1     605 /* Afstand van stopstreep tot start aanvraag gebied RIS SRM0 fase 38                                 */
    #define prmrisastart84fts1         606 /* Afstand van stopstreep tot start aanvraag gebied RIS CAM fase 84                                  */
    #define prmrisastartsrm084fts1     607 /* Afstand van stopstreep tot start aanvraag gebied RIS SRM0 fase 84                                 */
    #define prmrisastart82fts1         608 /* Afstand van stopstreep tot start aanvraag gebied RIS CAM fase 82                                  */
    #define prmrisastartsrm082fts1     609 /* Afstand van stopstreep tot start aanvraag gebied RIS SRM0 fase 82                                 */
    #define prmrisastart81fts1         610 /* Afstand van stopstreep tot start aanvraag gebied RIS CAM fase 81                                  */
    #define prmrisastartsrm081fts1     611 /* Afstand van stopstreep tot start aanvraag gebied RIS SRM0 fase 81                                 */
    #define prmrisastart68mveh2        612 /* Afstand van stopstreep tot start aanvraag gebied RIS CAM fase 68                                  */
    #define prmrisastartsrm068mveh2    613 /* Afstand van stopstreep tot start aanvraag gebied RIS SRM0 fase 68                                 */
    #define prmrisastart68mveh1        614 /* Afstand van stopstreep tot start aanvraag gebied RIS CAM fase 68                                  */
    #define prmrisastartsrm068mveh1    615 /* Afstand van stopstreep tot start aanvraag gebied RIS SRM0 fase 68                                 */
    #define prmrisastart67mveh1        616 /* Afstand van stopstreep tot start aanvraag gebied RIS CAM fase 67                                  */
    #define prmrisastartsrm067mveh1    617 /* Afstand van stopstreep tot start aanvraag gebied RIS SRM0 fase 67                                 */
    #define prmrisastart62mveh2        618 /* Afstand van stopstreep tot start aanvraag gebied RIS CAM fase 62                                  */
    #define prmrisastartsrm062mveh2    619 /* Afstand van stopstreep tot start aanvraag gebied RIS SRM0 fase 62                                 */
    #define prmrisastart62mveh1        620 /* Afstand van stopstreep tot start aanvraag gebied RIS CAM fase 62                                  */
    #define prmrisastartsrm062mveh1    621 /* Afstand van stopstreep tot start aanvraag gebied RIS SRM0 fase 62                                 */
    #define prmrisastart61mveh1        622 /* Afstand van stopstreep tot start aanvraag gebied RIS CAM fase 61                                  */
    #define prmrisastartsrm061mveh1    623 /* Afstand van stopstreep tot start aanvraag gebied RIS SRM0 fase 61                                 */
    #define prmrisastart38vtg2         624 /* Afstand van stopstreep tot start aanvraag gebied RIS CAM fase 38                                  */
    #define prmrisastartsrm038vtg2     625 /* Afstand van stopstreep tot start aanvraag gebied RIS SRM0 fase 38                                 */
    ...
    #define prmrisaend38vtg1           670 /* Afstand van stopstreep tot einde aanvraag gebied RIS CAM fase 38                                  */
    #define prmrisaendsrm038vtg1       671 /* Afstand van stopstreep tot einde aanvraag gebied RIS SRM0 fase 38                                 */
    #define prmrisaend84fts1           672 /* Afstand van stopstreep tot einde aanvraag gebied RIS CAM fase 84                                  */
    #define prmrisaendsrm084fts1       673 /* Afstand van stopstreep tot einde aanvraag gebied RIS SRM0 fase 84                                 */
    #define prmrisaend82fts1           674 /* Afstand van stopstreep tot einde aanvraag gebied RIS CAM fase 82                                  */
    #define prmrisaendsrm082fts1       675 /* Afstand van stopstreep tot einde aanvraag gebied RIS SRM0 fase 82                                 */
    #define prmrisaend81fts1           676 /* Afstand van stopstreep tot einde aanvraag gebied RIS CAM fase 81                                  */
    #define prmrisaendsrm081fts1       677 /* Afstand van stopstreep tot einde aanvraag gebied RIS SRM0 fase 81                                 */
    #define prmrisaend68mveh2          678 /* Afstand van stopstreep tot einde aanvraag gebied RIS CAM fase 68                                  */
    #define prmrisaendsrm068mveh2      679 /* Afstand van stopstreep tot einde aanvraag gebied RIS SRM0 fase 68                                 */
    #define prmrisaend68mveh1          680 /* Afstand van stopstreep tot einde aanvraag gebied RIS CAM fase 68                                  */
    #define prmrisaendsrm068mveh1      681 /* Afstand van stopstreep tot einde aanvraag gebied RIS SRM0 fase 68                                 */
    #define prmrisaend67mveh1          682 /* Afstand van stopstreep tot einde aanvraag gebied RIS CAM fase 67                                  */
    #define prmrisaendsrm067mveh1      683 /* Afstand van stopstreep tot einde aanvraag gebied RIS SRM0 fase 67                                 */
    #define prmrisaend62mveh2          684 /* Afstand van stopstreep tot einde aanvraag gebied RIS CAM fase 62                                  */
    #define prmrisaendsrm062mveh2      685 /* Afstand van stopstreep tot einde aanvraag gebied RIS SRM0 fase 62                                 */
    #define prmrisaend62mveh1          686 /* Afstand van stopstreep tot einde aanvraag gebied RIS CAM fase 62                                  */
    #define prmrisaendsrm062mveh1      687 /* Afstand van stopstreep tot einde aanvraag gebied RIS SRM0 fase 62                                 */
    #define prmrisaend61mveh1          688 /* Afstand van stopstreep tot einde aanvraag gebied RIS CAM fase 61                                  */
    #define prmrisaendsrm061mveh1      689 /* Afstand van stopstreep tot einde aanvraag gebied RIS SRM0 fase 61                                 */
    #define prmrisaend38vtg2           690 /* Afstand van stopstreep tot einde aanvraag gebied RIS CAM fase 38                                  */
    #define prmrisaendsrm038vtg2       691 /* Afstand van stopstreep tot einde aanvraag gebied RIS SRM0 fase 38                                 */
    ...
    #define prmrisvstart38vtg1         736 /* Afstand van stopstreep tot start verleng gebied RIS CAM fase 38                                   */
    #define prmrisvstartsrm038vtg1     737 /* Afstand van stopstreep tot start verleng gebied RIS SRM0 fase 38                                  */
    #define prmrisvstart84fts1         738 /* Afstand van stopstreep tot start verleng gebied RIS CAM fase 84                                   */
    #define prmrisvstartsrm084fts1     739 /* Afstand van stopstreep tot start verleng gebied RIS SRM0 fase 84                                  */
    #define prmrisvstart82fts1         740 /* Afstand van stopstreep tot start verleng gebied RIS CAM fase 82                                   */
    #define prmrisvstartsrm082fts1     741 /* Afstand van stopstreep tot start verleng gebied RIS SRM0 fase 82                                  */
    #define prmrisvstart81fts1         742 /* Afstand van stopstreep tot start verleng gebied RIS CAM fase 81                                   */
    #define prmrisvstartsrm081fts1     743 /* Afstand van stopstreep tot start verleng gebied RIS SRM0 fase 81                                  */
    #define prmrisvstart68mveh2        744 /* Afstand van stopstreep tot start verleng gebied RIS CAM fase 68                                   */
    #define prmrisvstartsrm068mveh2    745 /* Afstand van stopstreep tot start verleng gebied RIS SRM0 fase 68                                  */
    #define prmrisvstart68mveh1        746 /* Afstand van stopstreep tot start verleng gebied RIS CAM fase 68                                   */
    #define prmrisvstartsrm068mveh1    747 /* Afstand van stopstreep tot start verleng gebied RIS SRM0 fase 68                                  */
    #define prmrisvstart67mveh1        748 /* Afstand van stopstreep tot start verleng gebied RIS CAM fase 67                                   */
    #define prmrisvstartsrm067mveh1    749 /* Afstand van stopstreep tot start verleng gebied RIS SRM0 fase 67                                  */
    #define prmrisvstart62mveh2        750 /* Afstand van stopstreep tot start verleng gebied RIS CAM fase 62                                   */
    #define prmrisvstartsrm062mveh2    751 /* Afstand van stopstreep tot start verleng gebied RIS SRM0 fase 62                                  */
    #define prmrisvstart62mveh1        752 /* Afstand van stopstreep tot start verleng gebied RIS CAM fase 62                                   */
    #define prmrisvstartsrm062mveh1    753 /* Afstand van stopstreep tot start verleng gebied RIS SRM0 fase 62                                  */
    #define prmrisvstart61mveh1        754 /* Afstand van stopstreep tot start verleng gebied RIS CAM fase 61                                   */
    #define prmrisvstartsrm061mveh1    755 /* Afstand van stopstreep tot start verleng gebied RIS SRM0 fase 61                                  */
    #define prmrisvstart38vtg2         756 /* Afstand van stopstreep tot start verleng gebied RIS CAM fase 38                                   */
    #define prmrisvstartsrm038vtg2     757 /* Afstand van stopstreep tot start verleng gebied RIS SRM0 fase 38                                  */
    ...
    #define prmrisvend38vtg1           802 /* Afstand van stopstreep tot einde verleng gebied RIS CAM fase 38                                   */
    #define prmrisvendsrm038vtg1       803 /* Afstand van stopstreep tot einde verleng gebied RIS SRM0 fase 38                                  */
    #define prmrisvend84fts1           804 /* Afstand van stopstreep tot einde verleng gebied RIS CAM fase 84                                   */
    #define prmrisvendsrm084fts1       805 /* Afstand van stopstreep tot einde verleng gebied RIS SRM0 fase 84                                  */
    #define prmrisvend82fts1           806 /* Afstand van stopstreep tot einde verleng gebied RIS CAM fase 82                                   */
    #define prmrisvendsrm082fts1       807 /* Afstand van stopstreep tot einde verleng gebied RIS SRM0 fase 82                                  */
    #define prmrisvend81fts1           808 /* Afstand van stopstreep tot einde verleng gebied RIS CAM fase 81                                   */
    #define prmrisvendsrm081fts1       809 /* Afstand van stopstreep tot einde verleng gebied RIS SRM0 fase 81                                  */
    #define prmrisvend68mveh2          810 /* Afstand van stopstreep tot einde verleng gebied RIS CAM fase 68                                   */
    #define prmrisvendsrm068mveh2      811 /* Afstand van stopstreep tot einde verleng gebied RIS SRM0 fase 68                                  */
    #define prmrisvend68mveh1          812 /* Afstand van stopstreep tot einde verleng gebied RIS CAM fase 68                                   */
    #define prmrisvendsrm068mveh1      813 /* Afstand van stopstreep tot einde verleng gebied RIS SRM0 fase 68                                  */
    #define prmrisvend67mveh1          814 /* Afstand van stopstreep tot einde verleng gebied RIS CAM fase 67                                   */
    #define prmrisvendsrm067mveh1      815 /* Afstand van stopstreep tot einde verleng gebied RIS SRM0 fase 67                                  */
    #define prmrisvend62mveh2          816 /* Afstand van stopstreep tot einde verleng gebied RIS CAM fase 62                                   */
    #define prmrisvendsrm062mveh2      817 /* Afstand van stopstreep tot einde verleng gebied RIS SRM0 fase 62                                  */
    #define prmrisvend62mveh1          818 /* Afstand van stopstreep tot einde verleng gebied RIS CAM fase 62                                   */
    #define prmrisvendsrm062mveh1      819 /* Afstand van stopstreep tot einde verleng gebied RIS SRM0 fase 62                                  */
    #define prmrisvend61mveh1          820 /* Afstand van stopstreep tot einde verleng gebied RIS CAM fase 61                                   */
    #define prmrisvendsrm061mveh1      821 /* Afstand van stopstreep tot einde verleng gebied RIS SRM0 fase 61                                  */
    #define prmrisvend38vtg2           822 /* Afstand van stopstreep tot einde verleng gebied RIS CAM fase 38                                   */
    #define prmrisvendsrm038vtg2       823 /* Afstand van stopstreep tot einde verleng gebied RIS SRM0 fase 38                                  */
