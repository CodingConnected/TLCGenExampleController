...
void simulation_parameters(void)
{
 ...
 RANDGEN_start = 123;  /* startwaarde randomgenerator */
    ...
    LNK_code[122] = "ris841cyclist";
    IS_nr[122] = isris841cyclist;
    FC_nr[122] = fc84;
    S_generator[122] = NG;
    S_stopline[122] = 0;
    Q1[122] = 0;
    ...
    LNK_code[123] = "ris821cyclist";
    IS_nr[123] = isris821cyclist;
    FC_nr[123] = fc82;
    S_generator[123] = NG;
    S_stopline[123] = 0;
    Q1[123] = 0;
    ...
    LNK_code[124] = "ris811cyclist";
    IS_nr[124] = isris811cyclist;
    FC_nr[124] = fc81;
    S_generator[124] = NG;
    S_stopline[124] = 0;
    Q1[124] = 0;
    ...
    LNK_code[125] = "ris681car";
    IS_nr[125] = isris681car;
    FC_nr[125] = fc68;
    S_generator[125] = NG;
    S_stopline[125] = 0;
    Q1[125] = 0;
    ...
    LNK_code[126] = "ris681bus";
    IS_nr[126] = isris681bus;
    FC_nr[126] = fc68;
    S_generator[126] = NG;
    S_stopline[126] = 0;
    Q1[126] = 0;
    ...
    LNK_code[127] = "ris681special";
    IS_nr[127] = isris681special;
    FC_nr[127] = NG;
    S_generator[127] = NG;
    S_stopline[127] = 0;
    Q1[127] = 0;
    ...
    LNK_code[128] = "ris681heavytruck";
    IS_nr[128] = isris681heavytruck;
    FC_nr[128] = fc68;
    S_generator[128] = NG;
    S_stopline[128] = 0;
    Q1[128] = 0;
    ...
    LNK_code[129] = "ris682car";
    IS_nr[129] = isris682car;
    FC_nr[129] = fc68;
    S_generator[129] = NG;
    S_stopline[129] = 0;
    Q1[129] = 0;
    ...
    LNK_code[130] = "ris682bus";
    IS_nr[130] = isris682bus;
    FC_nr[130] = fc68;
    S_generator[130] = NG;
    S_stopline[130] = 0;
    Q1[130] = 0;
    ...
    LNK_code[131] = "ris682special";
    IS_nr[131] = isris682special;
    FC_nr[131] = NG;
    S_generator[131] = NG;
    S_stopline[131] = 0;
    Q1[131] = 0;
    ...
    LNK_code[132] = "ris682heavytruck";
    IS_nr[132] = isris682heavytruck;
    FC_nr[132] = fc68;
    S_generator[132] = NG;
    S_stopline[132] = 0;
    Q1[132] = 0;
    ...
    LNK_code[133] = "ris671car";
    IS_nr[133] = isris671car;
    FC_nr[133] = fc67;
    S_generator[133] = NG;
    S_stopline[133] = 0;
    Q1[133] = 0;
    ...
    LNK_code[134] = "ris671bus";
    IS_nr[134] = isris671bus;
    FC_nr[134] = fc67;
    S_generator[134] = NG;
    S_stopline[134] = 0;
    Q1[134] = 0;
    ...
    LNK_code[135] = "ris671special";
    IS_nr[135] = isris671special;
    FC_nr[135] = NG;
    S_generator[135] = NG;
    S_stopline[135] = 0;
    Q1[135] = 0;
    ...
    LNK_code[136] = "ris671heavytruck";
    IS_nr[136] = isris671heavytruck;
    FC_nr[136] = fc67;
    S_generator[136] = NG;
    S_stopline[136] = 0;
    Q1[136] = 0;
    ...
    LNK_code[137] = "ris621car";
    IS_nr[137] = isris621car;
    FC_nr[137] = fc62;
    S_generator[137] = NG;
    S_stopline[137] = 0;
    Q1[137] = 0;
    ...
    LNK_code[138] = "ris621bus";
    IS_nr[138] = isris621bus;
    FC_nr[138] = fc62;
    S_generator[138] = NG;
    S_stopline[138] = 0;
    Q1[138] = 0;
    ...
    LNK_code[139] = "ris621special";
    IS_nr[139] = isris621special;
    FC_nr[139] = NG;
    S_generator[139] = NG;
    S_stopline[139] = 0;
    Q1[139] = 0;
    ...
    LNK_code[140] = "ris621heavytruck";
    IS_nr[140] = isris621heavytruck;
    FC_nr[140] = fc62;
    S_generator[140] = NG;
    S_stopline[140] = 0;
    Q1[140] = 0;
    ...
    LNK_code[141] = "ris622car";
    IS_nr[141] = isris622car;
    FC_nr[141] = fc62;
    S_generator[141] = NG;
    S_stopline[141] = 0;
    Q1[141] = 0;
    ...
    LNK_code[142] = "ris622bus";
    IS_nr[142] = isris622bus;
    FC_nr[142] = fc62;
    S_generator[142] = NG;
    S_stopline[142] = 0;
    Q1[142] = 0;
    ...
    LNK_code[143] = "ris622special";
    IS_nr[143] = isris622special;
    FC_nr[143] = NG;
    S_generator[143] = NG;
    S_stopline[143] = 0;
    Q1[143] = 0;
    ...
    LNK_code[144] = "ris622heavytruck";
    IS_nr[144] = isris622heavytruck;
    FC_nr[144] = fc62;
    S_generator[144] = NG;
    S_stopline[144] = 0;
    Q1[144] = 0;
    ...
    LNK_code[145] = "ris611car";
    IS_nr[145] = isris611car;
    FC_nr[145] = fc61;
    S_generator[145] = NG;
    S_stopline[145] = 0;
    Q1[145] = 0;
    ...
    LNK_code[146] = "ris611bus";
    IS_nr[146] = isris611bus;
    FC_nr[146] = fc61;
    S_generator[146] = NG;
    S_stopline[146] = 0;
    Q1[146] = 0;
    ...
    LNK_code[147] = "ris611special";
    IS_nr[147] = isris611special;
    FC_nr[147] = NG;
    S_generator[147] = NG;
    S_stopline[147] = 0;
    Q1[147] = 0;
    ...
    LNK_code[148] = "ris611heavytruck";
    IS_nr[148] = isris611heavytruck;
    FC_nr[148] = fc61;
    S_generator[148] = NG;
    S_stopline[148] = 0;
    Q1[148] = 0;
    ...
    LNK_code[151] = "ris341pedestrian";
    IS_nr[151] = isris341pedestrian;
    FC_nr[151] = fc34;
    S_generator[151] = NG;
    S_stopline[151] = 0;
    Q1[151] = 0;
    ...
    LNK_code[152] = "ris342pedestrian";
    IS_nr[152] = isris342pedestrian;
    FC_nr[152] = fc34;
    S_generator[152] = NG;
    S_stopline[152] = 0;
    Q1[152] = 0;
    ...
    LNK_code[153] = "ris331pedestrian";
    IS_nr[153] = isris331pedestrian;
    FC_nr[153] = fc33;
    S_generator[153] = NG;
    S_stopline[153] = 0;
    Q1[153] = 0;
    ...
    LNK_code[154] = "ris332pedestrian";
    IS_nr[154] = isris332pedestrian;
    FC_nr[154] = fc33;
    S_generator[154] = NG;
    S_stopline[154] = 0;
    Q1[154] = 0;
    ...
    LNK_code[157] = "ris311pedestrian";
    IS_nr[157] = isris311pedestrian;
    FC_nr[157] = fc31;
    S_generator[157] = NG;
    S_stopline[157] = 0;
    Q1[157] = 0;
    ...
    LNK_code[158] = "ris312pedestrian";
    IS_nr[158] = isris312pedestrian;
    FC_nr[158] = fc31;
    S_generator[158] = NG;
    S_stopline[158] = 0;
    Q1[158] = 0;
    ...
    LNK_code[159] = "ris281cyclist";
    IS_nr[159] = isris281cyclist;
    FC_nr[159] = fc28;
    S_generator[159] = NG;
    S_stopline[159] = 0;
    Q1[159] = 0;
    ...
    LNK_code[160] = "ris261cyclist";
    IS_nr[160] = isris261cyclist;
    FC_nr[160] = fc26;
    S_generator[160] = NG;
    S_stopline[160] = 0;
    Q1[160] = 0;
    ...
    LNK_code[161] = "ris241cyclist";
    IS_nr[161] = isris241cyclist;
    FC_nr[161] = fc24;
    S_generator[161] = NG;
    S_stopline[161] = 0;
    Q1[161] = 0;
    ...
    LNK_code[162] = "ris221cyclist";
    IS_nr[162] = isris221cyclist;
    FC_nr[162] = fc22;
    S_generator[162] = NG;
    S_stopline[162] = 0;
    Q1[162] = 0;
    ...
    LNK_code[163] = "ris211cyclist";
    IS_nr[163] = isris211cyclist;
    FC_nr[163] = fc21;
    S_generator[163] = NG;
    S_stopline[163] = 0;
    Q1[163] = 0;
    ...
    LNK_code[164] = "ris111car";
    IS_nr[164] = isris111car;
    FC_nr[164] = fc11;
    S_generator[164] = NG;
    S_stopline[164] = 0;
    Q1[164] = 0;
    ...
    LNK_code[165] = "ris111bus";
    IS_nr[165] = isris111bus;
    FC_nr[165] = fc11;
    S_generator[165] = NG;
    S_stopline[165] = 0;
    Q1[165] = 0;
    ...
    LNK_code[166] = "ris111special";
    IS_nr[166] = isris111special;
    FC_nr[166] = NG;
    S_generator[166] = NG;
    S_stopline[166] = 0;
    Q1[166] = 0;
    ...
    LNK_code[167] = "ris111heavytruck";
    IS_nr[167] = isris111heavytruck;
    FC_nr[167] = fc11;
    S_generator[167] = NG;
    S_stopline[167] = 0;
    Q1[167] = 0;
    ...
    LNK_code[168] = "ris091car";
    IS_nr[168] = isris091car;
    FC_nr[168] = fc09;
    S_generator[168] = NG;
    S_stopline[168] = 0;
    Q1[168] = 0;
    ...
    LNK_code[169] = "ris091bus";
    IS_nr[169] = isris091bus;
    FC_nr[169] = fc09;
    S_generator[169] = NG;
    S_stopline[169] = 0;
    Q1[169] = 0;
    ...
    LNK_code[170] = "ris091special";
    IS_nr[170] = isris091special;
    FC_nr[170] = NG;
    S_generator[170] = NG;
    S_stopline[170] = 0;
    Q1[170] = 0;
    ...
    LNK_code[171] = "ris091heavytruck";
    IS_nr[171] = isris091heavytruck;
    FC_nr[171] = fc09;
    S_generator[171] = NG;
    S_stopline[171] = 0;
    Q1[171] = 0;
    ...
    LNK_code[172] = "ris081car";
    IS_nr[172] = isris081car;
    FC_nr[172] = fc08;
    S_generator[172] = NG;
    S_stopline[172] = 0;
    Q1[172] = 0;
    ...
    LNK_code[173] = "ris081bus";
    IS_nr[173] = isris081bus;
    FC_nr[173] = fc08;
    S_generator[173] = NG;
    S_stopline[173] = 0;
    Q1[173] = 0;
    ...
    LNK_code[174] = "ris081special";
    IS_nr[174] = isris081special;
    FC_nr[174] = NG;
    S_generator[174] = NG;
    S_stopline[174] = 0;
    Q1[174] = 0;
    ...
    LNK_code[175] = "ris081heavytruck";
    IS_nr[175] = isris081heavytruck;
    FC_nr[175] = fc08;
    S_generator[175] = NG;
    S_stopline[175] = 0;
    Q1[175] = 0;
    ...
    LNK_code[176] = "ris082car";
    IS_nr[176] = isris082car;
    FC_nr[176] = fc08;
    S_generator[176] = NG;
    S_stopline[176] = 0;
    Q1[176] = 0;
    ...
    LNK_code[177] = "ris082bus";
    IS_nr[177] = isris082bus;
    FC_nr[177] = fc08;
    S_generator[177] = NG;
    S_stopline[177] = 0;
    Q1[177] = 0;
    ...
    LNK_code[178] = "ris082special";
    IS_nr[178] = isris082special;
    FC_nr[178] = NG;
    S_generator[178] = NG;
    S_stopline[178] = 0;
    Q1[178] = 0;
    ...
    LNK_code[179] = "ris082heavytruck";
    IS_nr[179] = isris082heavytruck;
    FC_nr[179] = fc08;
    S_generator[179] = NG;
    S_stopline[179] = 0;
    Q1[179] = 0;
