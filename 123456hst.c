...
void Alternatief_halfstar(void)
{
    ...
    alternatief_halfstar(fc22, PRM[prmaltphst22], SCH[schaltghst22]);
    alternatief_halfstar(fc24, PRM[prmaltphst24], SCH[schaltghst24]);
    ...
    alternatief_halfstar(fc32, PRM[prmaltphst32], SCH[schaltghst32]);
    alternatief_halfstar(fc33, PRM[prmaltphst33], SCH[schaltghst33]);
    alternatief_halfstar(fc34, PRM[prmaltphst34], SCH[schaltghst34]);
    ...
    alternatief_halfstar(fc84, PRM[prmaltphst84], SCH[schaltghst84]);
