...
void PreApplication(void)
{
    ...
    IH[hgeendynhiaat02] = !SCH[schdynhiaat02];
    ...
    /* Instellen basis waarde hulpelementen opdrempelen t.b.v. dynamische hiaattijden.
       Dit hulpelement kan in gebruikers code worden gebruikt voor eigen aansturing. */
    IH[hopdrempelen02] = SCH[schopdrempelen02];
...
void Aanvragen(void)
{
    ...
    #ifndef NO_RIS
        /* RIS aanvragen */
        if (ris_aanvraag(fc02, SYSTEM_ITF, PRM[prmrislaneid02_1], RIS_MOTORVEHICLES, PRM[prmrisastart02mveh1], PRM[prmrisaend02mveh1], SCH[schrisgeencheckopsg])) A[fc02] |= BIT10;
        if (ris_aanvraag(fc02, SYSTEM_ITF, PRM[prmrislaneid02_2], RIS_MOTORVEHICLES, PRM[prmrisastart02mveh2], PRM[prmrisaend02mveh2], SCH[schrisgeencheckopsg])) A[fc02] |= BIT10;
...
void BepaalRealisatieTijden(void)
{
    ...
    /* Herstarten/afkappen inlooptijd */
...
void Maxgroen(void)
{
    ...
    maximumgroentijden_va_arg((count) fc02,
                              (va_mulv) PRM[prmmg2_02], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_02], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_02], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_02], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_02], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_02], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_02], (va_count) END);
    maximumgroentijden_va_arg((count) fc03,
                              (va_mulv) PRM[prmmg2_03], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_03], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_03], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_03], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_03], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_03], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_03], (va_count) END);
    maximumgroentijden_va_arg((count) fc05,
                              (va_mulv) PRM[prmmg2_05], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_05], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_05], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_05], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_05], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_05], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_05], (va_count) END);
    maximumgroentijden_va_arg((count) fc08,
                              (va_mulv) PRM[prmmg2_08], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_08], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_08], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_08], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_08], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_08], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_08], (va_count) END);
    maximumgroentijden_va_arg((count) fc09,
                              (va_mulv) PRM[prmmg2_09], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_09], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_09], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_09], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_09], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_09], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_09], (va_count) END);
    maximumgroentijden_va_arg((count) fc11,
                              (va_mulv) PRM[prmmg2_11], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_11], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_11], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_11], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_11], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_11], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_11], (va_count) END);
    maximumgroentijden_va_arg((count) fc21,
                              (va_mulv) PRM[prmmg2_21], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_21], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_21], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_21], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_21], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_21], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_21], (va_count) END);
    maximumgroentijden_va_arg((count) fc22,
                              (va_mulv) PRM[prmmg2_22], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_22], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_22], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_22], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_22], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_22], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_22], (va_count) END);
    maximumgroentijden_va_arg((count) fc24,
                              (va_mulv) PRM[prmmg2_24], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_24], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_24], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_24], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_24], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_24], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_24], (va_count) END);
    maximumgroentijden_va_arg((count) fc26,
                              (va_mulv) PRM[prmmg2_26], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_26], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_26], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_26], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_26], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_26], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_26], (va_count) END);
    maximumgroentijden_va_arg((count) fc28,
                              (va_mulv) PRM[prmmg2_28], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_28], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_28], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_28], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_28], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_28], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_28], (va_count) END);
    TVG_max[fc31] = 0;
    TVG_max[fc32] = 0;
    TVG_max[fc33] = 0;
    TVG_max[fc34] = 0;
    TVG_max[fc38] = 0;
    maximumgroentijden_va_arg((count) fc61,
                              (va_mulv) PRM[prmmg2_61], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_61], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_61], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_61], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_61], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_61], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_61], (va_count) END);
    maximumgroentijden_va_arg((count) fc62,
                              (va_mulv) PRM[prmmg2_62], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_62], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_62], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_62], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_62], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_62], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_62], (va_count) END);
    maximumgroentijden_va_arg((count) fc67,
                              (va_mulv) PRM[prmmg2_67], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_67], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_67], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_67], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_67], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_67], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_67], (va_count) END);
    maximumgroentijden_va_arg((count) fc68,
                              (va_mulv) PRM[prmmg2_68], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_68], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_68], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_68], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_68], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_68], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_68], (va_count) END);
    maximumgroentijden_va_arg((count) fc81,
                              (va_mulv) PRM[prmmg2_81], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_81], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_81], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_81], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_81], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_81], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_81], (va_count) END);
    maximumgroentijden_va_arg((count) fc82,
                              (va_mulv) PRM[prmmg2_82], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_82], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_82], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_82], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_82], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_82], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_82], (va_count) END);
    maximumgroentijden_va_arg((count) fc84,
                              (va_mulv) PRM[prmmg2_84], (va_mulv) (MM[mperiod] == 1),
                              (va_mulv) PRM[prmmg3_84], (va_mulv) (MM[mperiod] == 2),
                              (va_mulv) PRM[prmmg4_84], (va_mulv) (MM[mperiod] == 3),
                              (va_mulv) PRM[prmmg5_84], (va_mulv) (MM[mperiod] == 4),
                              (va_mulv) PRM[prmmg6_84], (va_mulv) (MM[mperiod] == 5),
                              (va_mulv) PRM[prmmg7_84], (va_mulv) (MM[mperiod] == 6),
                              (va_mulv) PRM[prmmg1_84], (va_count) END);
...
void Meetkriterium(void)
{
    ...
    meetkriterium2_prm_va_arg((count)fc02, (count)tkm02, (count)mmk02, 
                             ...
                             (va_boolv)TDH[d02_1b], (va_mulv)PRM[prmmk02_1b],
                             (va_boolv)TDH[d02_2a], (va_mulv)PRM[prmmk02_2a],
                             (va_boolv)TDH[d02_2b], (va_mulv)PRM[prmmk02_2b],
                             (va_boolv)TDH[d02_3a], (va_mulv)PRM[prmmk02_3a],
                             (va_boolv)TDH[d02_3b], (va_mulv)PRM[prmmk02_3b],
                             (va_boolv)TDH[d02_4a], (va_mulv)PRM[prmmk02_4a],
                             (va_boolv)TDH[d02_4b], (va_mulv)PRM[prmmk02_4b],
                             (va_count)END);
    ...
    for (fc = 0; fc < FCMAX; ++fc)
    {
        ...
        if (ris_verlengen(fc02, SYSTEM_ITF, PRM[prmrislaneid02_1], RIS_MOTORVEHICLES, PRM[prmrisvstart02mveh1], PRM[prmrisvend02mveh1], SCH[schrisgeencheckopsg])) MK[fc02] |= BIT10;
        if (ris_verlengen(fc02, SYSTEM_ITF, PRM[prmrislaneid02_2], RIS_MOTORVEHICLES, PRM[prmrisvstart02mveh2], PRM[prmrisvend02mveh2], SCH[schrisgeencheckopsg])) MK[fc02] |= BIT10;
...
void Meeverlengen(void)
{
    ...
    YM[fc31] |= SCH[schmv31] && ym_max_prmV1(fc31, prmmv31, NG) && hf_wsg() ? BIT4 : 0;
    YM[fc32] |= SCH[schmv32] && ym_max_prmV1(fc32, prmmv32, NG) && hf_wsg() ? BIT4 : 0;
    YM[fc33] |= SCH[schmv33] && ym_max_prmV1(fc33, prmmv33, NG) && hf_wsg() ? BIT4 : 0;
    YM[fc34] |= SCH[schmv34] && ym_max_prmV1(fc34, prmmv34, NG) && hf_wsg() ? BIT4 : 0;
...
void RealisatieAfhandeling(void)
{
    ...
    if (((Z[fc08] & PRIO_Z_BIT) && (YV[fc03] & PRIO_YV_BIT) && !G[fc03]) ||
        ((Z[fc08] & PRIO_Z_BIT) && (YV[fc05] & PRIO_YV_BIT) && !G[fc05])) RR[fc08] |= BIT10;
    if (((Z[fc11] & PRIO_Z_BIT) && (YV[fc03] & PRIO_YV_BIT) && !G[fc03]) ||
        ((Z[fc11] & PRIO_Z_BIT) && (YV[fc05] & PRIO_YV_BIT) && !G[fc05])) RR[fc11] |= BIT10;
...
void DetectieStoring(void)
{
    ...
    /* Vaste aanvraag bij detectie storing (per detector) */

    /* vaste aanvraag bij detectiestoring alle aanvraaglussen */
    RT[tdstvert02] = !T[tdstvert02] && R[fc02] && !A[fc02] && ((CIF_IS[d02_1a] >= CIF_DET_STORING || PRM[prmda02_1a] == 0) &&
                     ...
                     !(PRM[prmda02_1a] == 0 && PRM[prmda02_1b] == 0 && PRM[prmda02_2a] == 0 && PRM[prmda02_3a] == 0) ||
                     ...
                     !(PRM[prmda02_2b] == 0 && PRM[prmda02_3b] == 0 && PRM[prmda02_4b] == 0));
    RT[tdstvert03] = !T[tdstvert03] && R[fc03] && !A[fc03] && ((CIF_IS[d03_1] >= CIF_DET_STORING || PRM[prmda03_1] == 0) &&
                     (CIF_IS[d03_2] >= CIF_DET_STORING || PRM[prmda03_2] == 0) &&
                     !(PRM[prmda03_1] == 0 && PRM[prmda03_2] == 0));
    RT[tdstvert05] = !T[tdstvert05] && R[fc05] && !A[fc05] && ((CIF_IS[d05_1] >= CIF_DET_STORING || PRM[prmda05_1] == 0) &&
                     (CIF_IS[d05_2] >= CIF_DET_STORING || PRM[prmda05_2] == 0) &&
                     !(PRM[prmda05_1] == 0 && PRM[prmda05_2] == 0));
    RT[tdstvert08] = !T[tdstvert08] && R[fc08] && !A[fc08] && ((CIF_IS[d08_1a] >= CIF_DET_STORING || PRM[prmda08_1a] == 0) &&
    ...
    RT[tdstvert09] = !T[tdstvert09] && R[fc09] && !A[fc09] && ((CIF_IS[d09_1] >= CIF_DET_STORING || PRM[prmda09_1] == 0) &&
                     (CIF_IS[d09_2] >= CIF_DET_STORING || PRM[prmda09_2] == 0) &&
                     (CIF_IS[d09_3] >= CIF_DET_STORING || PRM[prmda09_3] == 0) &&
                     !(PRM[prmda09_1] == 0 && PRM[prmda09_2] == 0 && PRM[prmda09_3] == 0));
    RT[tdstvert11] = !T[tdstvert11] && R[fc11] && !A[fc11] && ((CIF_IS[d11_1] >= CIF_DET_STORING || PRM[prmda11_1] == 0) &&
    ...
    RT[tdstvert21] = !T[tdstvert21] && R[fc21] && !A[fc21] && ((CIF_IS[d211] >= CIF_DET_STORING || PRM[prmda211] == 0) &&
                     (CIF_IS[dk21] >= CIF_DET_STORING || PRM[prmdak21] == 0) &&
                     !(PRM[prmda211] == 0 && PRM[prmdak21] == 0));
    RT[tdstvert22] = !T[tdstvert22] && R[fc22] && !A[fc22] && ((CIF_IS[d22_1] >= CIF_DET_STORING || PRM[prmda22_1] == 0) &&
                     (CIF_IS[dk22] >= CIF_DET_STORING || PRM[prmdak22] == 0) &&
                     !(PRM[prmda22_1] == 0 && PRM[prmdak22] == 0));
    RT[tdstvert24] = !T[tdstvert24] && R[fc24] && !A[fc24] && ((CIF_IS[d24_1] >= CIF_DET_STORING || PRM[prmda24_1] == 0) &&
                     (CIF_IS[dk24] >= CIF_DET_STORING || PRM[prmdak24] == 0) &&
                     !(PRM[prmda24_1] == 0 && PRM[prmdak24] == 0));
    RT[tdstvert26] = !T[tdstvert26] && R[fc26] && !A[fc26] && ((CIF_IS[d261] >= CIF_DET_STORING || PRM[prmda261] == 0) &&
                     (CIF_IS[dk26] >= CIF_DET_STORING || PRM[prmdak26] == 0) &&
                     !(PRM[prmda261] == 0 && PRM[prmdak26] == 0));
    RT[tdstvert28] = !T[tdstvert28] && R[fc28] && !A[fc28] && ((CIF_IS[d28_1] >= CIF_DET_STORING || PRM[prmda28_1] == 0) &&
                     (CIF_IS[dk28] >= CIF_DET_STORING || PRM[prmdak28] == 0) &&
                     !(PRM[prmda28_1] == 0 && PRM[prmdak28] == 0));
    RT[tdstvert31] = !T[tdstvert31] && R[fc31] && !A[fc31] && ((CIF_IS[dk31a] >= CIF_DET_STORING || PRM[prmdak31a] == 0) &&
                     (CIF_IS[dk31b] >= CIF_DET_STORING || PRM[prmdak31b] == 0) && !(PRM[prmdak31a] == 0 && PRM[prmdak31b] == 0));
    RT[tdstvert32] = !T[tdstvert32] && R[fc32] && !A[fc32] && ((CIF_IS[dk32a] >= CIF_DET_STORING || PRM[prmdak32a] == 0) &&
                     (CIF_IS[dk32b] >= CIF_DET_STORING || PRM[prmdak32b] == 0) && !(PRM[prmdak32a] == 0 && PRM[prmdak32b] == 0));
    RT[tdstvert33] = !T[tdstvert33] && R[fc33] && !A[fc33] && ((CIF_IS[dk33a] >= CIF_DET_STORING || PRM[prmdak33a] == 0) &&
                     (CIF_IS[dk33b] >= CIF_DET_STORING || PRM[prmdak33b] == 0) && !(PRM[prmdak33a] == 0 && PRM[prmdak33b] == 0));
    RT[tdstvert34] = !T[tdstvert34] && R[fc34] && !A[fc34] && ((CIF_IS[dk34a] >= CIF_DET_STORING || PRM[prmdak34a] == 0) &&
                     (CIF_IS[dk34b] >= CIF_DET_STORING || PRM[prmdak34b] == 0) && !(PRM[prmdak34a] == 0 && PRM[prmdak34b] == 0));
    RT[tdstvert38] = !T[tdstvert38] && R[fc38] && !A[fc38] && ((CIF_IS[dk38a] >= CIF_DET_STORING || PRM[prmdak38a] == 0) &&
                     (CIF_IS[dk38b] >= CIF_DET_STORING || PRM[prmdak38b] == 0) && !(PRM[prmdak38a] == 0 && PRM[prmdak38b] == 0));
    RT[tdstvert61] = !T[tdstvert61] && R[fc61] && !A[fc61] && ((CIF_IS[d61_1] >= CIF_DET_STORING || PRM[prmda61_1] == 0) &&
                     (CIF_IS[d61_2] >= CIF_DET_STORING || PRM[prmda61_2] == 0) &&
                     !(PRM[prmda61_1] == 0 && PRM[prmda61_2] == 0));
    RT[tdstvert62] = !T[tdstvert62] && R[fc62] && !A[fc62] && ((CIF_IS[d62_1a] >= CIF_DET_STORING || PRM[prmda62_1a] == 0) &&
                     ...
                     !(PRM[prmda62_2b] == 0));
    RT[tdstvert67] = !T[tdstvert67] && R[fc67] && !A[fc67] && ((CIF_IS[d67_1] >= CIF_DET_STORING || PRM[prmda67_1] == 0) &&
                     (CIF_IS[d67_2] >= CIF_DET_STORING || PRM[prmda67_2] == 0) &&
                     !(PRM[prmda67_1] == 0 && PRM[prmda67_2] == 0));
    RT[tdstvert68] = !T[tdstvert68] && R[fc68] && !A[fc68] && ((CIF_IS[d68_1a] >= CIF_DET_STORING || PRM[prmda68_1a] == 0) &&
    ...
    RT[tdstvert81] = !T[tdstvert81] && R[fc81] && !A[fc81] && ((CIF_IS[d81_1] >= CIF_DET_STORING || PRM[prmda81_1] == 0) &&
                     (CIF_IS[dk81] >= CIF_DET_STORING || PRM[prmdak81] == 0) &&
                     !(PRM[prmda81_1] == 0 && PRM[prmdak81] == 0));
    RT[tdstvert82] = !T[tdstvert82] && R[fc82] && !A[fc82] && ((CIF_IS[d82_1] >= CIF_DET_STORING || PRM[prmda82_1] == 0) &&
                     (CIF_IS[dk82] >= CIF_DET_STORING || PRM[prmdak82] == 0) &&
                     !(PRM[prmda82_1] == 0 && PRM[prmdak82] == 0));
    RT[tdstvert84] = !T[tdstvert84] && R[fc84] && !A[fc84] && ((CIF_IS[d84_1] >= CIF_DET_STORING || PRM[prmda84_1] == 0) &&
                     (CIF_IS[dk84] >= CIF_DET_STORING || PRM[prmdak84] == 0) &&
                     !(PRM[prmda84_1] == 0 && PRM[prmdak84] == 0));
    A[fc02] |= ET[tdstvert02];
    A[fc03] |= ET[tdstvert03];
    A[fc05] |= ET[tdstvert05];
    A[fc08] |= ET[tdstvert08];
    A[fc09] |= ET[tdstvert09];
    A[fc11] |= ET[tdstvert11];
    A[fc21] |= ET[tdstvert21];
    A[fc22] |= ET[tdstvert22];
    A[fc24] |= ET[tdstvert24];
    A[fc26] |= ET[tdstvert26];
    A[fc28] |= ET[tdstvert28];
    A[fc31] |= ET[tdstvert31];
    A[fc32] |= ET[tdstvert32];
    A[fc33] |= ET[tdstvert33];
    A[fc34] |= ET[tdstvert34];
    A[fc38] |= ET[tdstvert38];
    A[fc61] |= ET[tdstvert61];
    A[fc62] |= ET[tdstvert62];
    A[fc67] |= ET[tdstvert67];
    A[fc68] |= ET[tdstvert68];
    A[fc81] |= ET[tdstvert81];
    A[fc82] |= ET[tdstvert82];
    A[fc84] |= ET[tdstvert84];
    ...
    /* ---------------------------------------------- */
    if ((CIF_IS[d02_1a] >= CIF_DET_STORING) && (CIF_IS[d02_1b] >= CIF_DET_STORING) && (CIF_IS[d02_2a] >= CIF_DET_STORING) && (CIF_IS[d02_3a] >= CIF_DET_STORING) ||
        (CIF_IS[d02_2b] >= CIF_DET_STORING) && (CIF_IS[d02_3b] >= CIF_DET_STORING))
    {
        MK[fc02] |= BIT5;
        PercentageMaxGroenTijden(fc02, mperiod, prmperc02, 
                                 7, prmmg1_02, prmmg2_02, prmmg3_02, prmmg4_02, prmmg5_02, prmmg6_02, prmmg7_02);
    }
    if ((CIF_IS[d03_1] >= CIF_DET_STORING) && (CIF_IS[d03_2] >= CIF_DET_STORING))
    {
        MK[fc03] |= BIT5;
        PercentageMaxGroenTijden(fc03, mperiod, prmperc03, 
                                 7, prmmg1_03, prmmg2_03, prmmg3_03, prmmg4_03, prmmg5_03, prmmg6_03, prmmg7_03);
    }
    if ((CIF_IS[d05_1] >= CIF_DET_STORING) && (CIF_IS[d05_2] >= CIF_DET_STORING))
    {
        MK[fc05] |= BIT5;
        PercentageMaxGroenTijden(fc05, mperiod, prmperc05, 
                                 7, prmmg1_05, prmmg2_05, prmmg3_05, prmmg4_05, prmmg5_05, prmmg6_05, prmmg7_05);
    }
    ...
    if ((CIF_IS[d09_1] >= CIF_DET_STORING) && (CIF_IS[d09_2] >= CIF_DET_STORING) && (CIF_IS[d09_3] >= CIF_DET_STORING))
    {
        ...
        PercentageMaxGroenTijden(fc09, mperiod, prmperc09, 
                                 7, prmmg1_09, prmmg2_09, prmmg3_09, prmmg4_09, prmmg5_09, prmmg6_09, prmmg7_09);
    }
    ...
    if ((CIF_IS[d61_1] >= CIF_DET_STORING) && (CIF_IS[d61_2] >= CIF_DET_STORING))
    {
        ...
        PercentageMaxGroenTijden(fc61, mperiod, prmperc61, 
                                 7, prmmg1_61, prmmg2_61, prmmg3_61, prmmg4_61, prmmg5_61, prmmg6_61, prmmg7_61);
    }
        ...
        (CIF_IS[d62_2b] >= CIF_DET_STORING))
    {
        ...
        PercentageMaxGroenTijden(fc62, mperiod, prmperc62, 
                                 7, prmmg1_62, prmmg2_62, prmmg3_62, prmmg4_62, prmmg5_62, prmmg6_62, prmmg7_62);
    }
    if ((CIF_IS[d67_1] >= CIF_DET_STORING) && (CIF_IS[d67_2] >= CIF_DET_STORING))
    {
        MK[fc67] |= BIT5;
        PercentageMaxGroenTijden(fc67, mperiod, prmperc67, 
                                 7, prmmg1_67, prmmg2_67, prmmg3_67, prmmg4_67, prmmg5_67, prmmg6_67, prmmg7_67);
    }
        ...
        (CIF_IS[d68_2b] >= CIF_DET_STORING))
    {
        ...
        PercentageMaxGroenTijden(fc68, mperiod, prmperc68, 
                                 7, prmmg1_68, prmmg2_68, prmmg3_68, prmmg4_68, prmmg5_68, prmmg6_68, prmmg7_68);
    }
...
void PostApplication(void)
{
    ...
    CIF_GUS[usovtevroeg02] = MM[mstp02bus] == CIF_TE_VROEG;
    CIF_GUS[usovoptijd02] = MM[mstp02bus] == CIF_OP_TIJD;
    CIF_GUS[usovtelaat02] = MM[mstp02bus] == CIF_TE_LAAT;
    CIF_GUS[usovtevroeg03] = MM[mstp03bus] == CIF_TE_VROEG;
    CIF_GUS[usovoptijd03] = MM[mstp03bus] == CIF_OP_TIJD;
    CIF_GUS[usovtelaat03] = MM[mstp03bus] == CIF_TE_LAAT;
    CIF_GUS[usovtevroeg05] = MM[mstp05bus] == CIF_TE_VROEG;
    CIF_GUS[usovoptijd05] = MM[mstp05bus] == CIF_OP_TIJD;
    CIF_GUS[usovtelaat05] = MM[mstp05bus] == CIF_TE_LAAT;
    CIF_GUS[usovtevroeg08] = MM[mstp08bus] == CIF_TE_VROEG;
    CIF_GUS[usovoptijd08] = MM[mstp08bus] == CIF_OP_TIJD;
    CIF_GUS[usovtelaat08] = MM[mstp08bus] == CIF_TE_LAAT;
    CIF_GUS[usovtevroeg09] = MM[mstp09bus] == CIF_TE_VROEG;
    CIF_GUS[usovoptijd09] = MM[mstp09bus] == CIF_OP_TIJD;
    CIF_GUS[usovtelaat09] = MM[mstp09bus] == CIF_TE_LAAT;
    CIF_GUS[usovtevroeg11] = MM[mstp11bus] == CIF_TE_VROEG;
    CIF_GUS[usovoptijd11] = MM[mstp11bus] == CIF_OP_TIJD;
    CIF_GUS[usovtelaat11] = MM[mstp11bus] == CIF_TE_LAAT;
    CIF_GUS[usovtevroeg61] = MM[mstp61bus] == CIF_TE_VROEG;
    CIF_GUS[usovoptijd61] = MM[mstp61bus] == CIF_OP_TIJD;
    CIF_GUS[usovtelaat61] = MM[mstp61bus] == CIF_TE_LAAT;
    CIF_GUS[usovtevroeg62] = MM[mstp62bus] == CIF_TE_VROEG;
    CIF_GUS[usovoptijd62] = MM[mstp62bus] == CIF_OP_TIJD;
    CIF_GUS[usovtelaat62] = MM[mstp62bus] == CIF_TE_LAAT;
    CIF_GUS[usovtevroeg67] = MM[mstp67bus] == CIF_TE_VROEG;
    CIF_GUS[usovoptijd67] = MM[mstp67bus] == CIF_OP_TIJD;
    CIF_GUS[usovtelaat67] = MM[mstp67bus] == CIF_TE_LAAT;
    CIF_GUS[usovtevroeg68] = MM[mstp68bus] == CIF_TE_VROEG;
    CIF_GUS[usovoptijd68] = MM[mstp68bus] == CIF_OP_TIJD;
    CIF_GUS[usovtelaat68] = MM[mstp68bus] == CIF_TE_LAAT;
...
void system_application(void)
{
    ...
    /* file verklikking */
    /* ---------------- */
    CIF_GUS[usfileFile68af] = IH[hfileFile68af];

    /* PRIO verklikking */
    /* ---------------- */
    CIF_GUS[usovinm02] = C[cvc02bus];
    CIF_GUS[usovinm03] = C[cvc03bus];
    CIF_GUS[usovinm05] = C[cvc05bus];
    CIF_GUS[usovinm08] = C[cvc08bus];
    CIF_GUS[usovinm09] = C[cvc09bus];
    CIF_GUS[usovinm11] = C[cvc11bus];
    CIF_GUS[usovinm61] = C[cvc61bus];
    CIF_GUS[usovinm62] = C[cvc62bus];
    CIF_GUS[usovinm67] = C[cvc67bus];
    CIF_GUS[usovinm68] = C[cvc68bus];
