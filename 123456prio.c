...
void PrioInstellingen(void) 
{
    ...
    else
    {
        ...
        iSCH_ALTG[fc22] = SCH[schaltghst22];
        iSCH_ALTG[fc24] = SCH[schaltghst24];
        iSCH_ALTG[fc26] = SCH[schaltghst26];
        iSCH_ALTG[fc28] = SCH[schaltghst28];
        iSCH_ALTG[fc31] = SCH[schaltghst31];
        iSCH_ALTG[fc32] = SCH[schaltghst32];
        iSCH_ALTG[fc33] = SCH[schaltghst33];
        iSCH_ALTG[fc34] = SCH[schaltghst34];
        ...
        iSCH_ALTG[fc84] = SCH[schaltghst84];
    }
...
void OnderMaximumExtra(void)
{
    ...
    no_prio_door_wtv(fc21, mwtv21, prmminwtv);
    no_prio_door_wtv(fc22, mwtv22, prmminwtv);
    no_prio_door_wtv(fc24, mwtv24, prmminwtv);
    no_prio_door_wtv(fc26, mwtv26, prmminwtv);
    no_prio_door_wtv(fc28, mwtv28, prmminwtv);
    no_prio_door_wtv(fc81, mwtv81, prmminwtv);
    no_prio_door_wtv(fc82, mwtv82, prmminwtv);
    no_prio_door_wtv(fc84, mwtv84, prmminwtv);
